            ...
            <li class="treeview">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
                    <li><a href="?page=category/index.php"><i class="fa fa-circle-o"></i> Manage Category</a></li>
                    <li><a href="?page=product/index.php"><i class="fa fa-circle-o"></i> Manage Product</a></li>
                </ul>
            </li>
